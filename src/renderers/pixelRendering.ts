/**
 * Pixel rendering — pure ImageData generation for neural network visualization.
 *
 * Converts weight vectors and pixel arrays into displayable ImageData objects.
 * Includes diverging colormaps, grayscale rendering, and pixel interpolation.
