/**
 * Network visualization — pure computation logic.
 *
 * Extracted from NetworkVisualizer.tsx to reduce component complexity
 * and enable independent testing of layout and particle generation.
 */
